...
def main(epochs, learning_rate):
    ...
    sft_job = sft.train(
        ...
        train_dataset=f"gs://veritas-trial/construct-qa/instruction_test.jsonl",
        validation_dataset=f"gs://veritas-trial/construct-qa/instruction_test.jsonl",
        epochs=epochs,
        learning_rate_multiplier=learning_rate,
        adapter_size=4,
        tuned_model_display_name=f"veritas-trial-{BASE_MODEL}",
    )
